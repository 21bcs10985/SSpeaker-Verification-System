...
import os
import logging
from register_user import  convert_webm_to_wav, record_audio_for_user  # Importing the record_audio_for_user function
...
def sign_up(username):
    ...
    try:
        ...
        ubm_model_path = r'C:\Users\LENOVO\Desktop\speaker\voiceauth\model\ubm_model.pkl'  # Replace with actual path to your UBM model
        model_save_directory = r'C:\Users\LENOVO\Desktop\speaker\voiceauth\model'
...
def login(user_name):
    ...
    detector = DeepfakeDetector(r"C:\Users\LENOVO\Desktop\speaker\DeepfakeDetection\models\best_model.pth")
    ...
    if result:
        ...
        # print(f"Probability of Real: {result['probabilities']['fake']:.2f}%")
        # print(f"Probability of Fake: {result['probabilities']['real']:.2f}%")

        
        # Check if it's a real or fake voice and return 1 or print failure message
        if result['prediction'] == 'REAL':
            model_path = os.path.join(r'C:\Users\LENOVO\Desktop\speaker\voiceauth\model', f"{user_name}.gmm")  # Corrected model path
...
def main():
    ...
    if action == "1":
        ...
        gmm_model_path = os.path.join(r'C:\Users\LENOVO\Desktop\speaker\voiceauth\model', f"{username}.gmm")
